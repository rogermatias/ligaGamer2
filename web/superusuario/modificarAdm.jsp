...
<%-- 
    ...
    Created on : 05-09-2018, 15:45:01
    Author     : franc
--%>
                            ...
                            <form action="../procesoUsuario" method="GET">
                                <div class="form-group">
                                    ...
                                    <sql:query var="usuario" dataSource="${dataSource}">
                                        SELECT nombre, id FROM usuario WHERE tipo_usuario=1 AND vigente=1
                                    </sql:query>
                                ...
                                <div class="form-group">
                                    <label>Usuario:</label>
                                    <input type="text" name="txtUser" placeholder="Ej: Josep"  required="" class="form-control"/>
                                </div>
                                <div class="form-group">
